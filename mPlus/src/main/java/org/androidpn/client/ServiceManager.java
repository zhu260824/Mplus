...
public final class ServiceManager {
	...
	public void startService() {
		Thread serviceThread = new Thread(new Runnable() {
			...
			public void run() {
				...
				intent.setPackage("com.mplus.mplus");
	...
	public static void setAlias(final String alias,Context context) {
		final String username =  context.getSharedPreferences(Constants.SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE).getString(Constants.XMPP_USERNAME,"");
