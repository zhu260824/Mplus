...
public class ChangeProjectTimeDialog extends Dialog implements android.view.View.OnClickListener {
	...
	public ChangeProjectTimeDialog(Context context) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_myinfo_changeprojecttime);
		...
		selectYear=getNowYear()+"";
//		wvYear.setCurrentItem(setYear(getNowYear()));
		wvYear.setCurrentItem(setYear(Integer.valueOf(selectYear)));
		initMonths(month);
...
//		wvMonth.setCurrentItem(setMonth(currentMonth));
		wvMonth.setCurrentItem(setMonth(Integer.valueOf(selectMonth)));
		initDays(day);
...
//		wvDay.setCurrentItem(currentDay - 1);
		wvDay.setCurrentItem(Integer.valueOf(selectDay) - 1);
	...
	public void onClick(View v) {
		...
		if (v == btnSure) {
			if (onTimeListener != null) {
				onTimeListener.onClick(selectYear, selectMonth, selectDay);
			}
		} else if (v == btnSure) {
